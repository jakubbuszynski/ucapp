...
import sty from "./PlasmicButton.module.css"; // plasmic-import: gP-HYzHmfTq/css
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__jV2KF)}
                role={"img"}
              />
            ),
            ...
            className: classNames(sty.slotTargetStartIcon, {
              ...
              [sty.slotTargetStartIconshowStartIcon_color_yellow]:
                hasVariant(variants, "showStartIcon", "showStartIcon") &&
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__iyl6Q)}
                role={"img"}
              />
            ),
